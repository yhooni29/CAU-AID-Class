...
## Notes
* Ensure that the input for predictions is numeric and follows the coreect format (`value1,value2`).
* Modify the dataset loading path in the scrip if necessary.
...
### Author
Developed by [yonghoon](https://github.com/yhooni29)